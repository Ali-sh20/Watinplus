...
class UploadImageScreenCover extends StatefulWidget {
  const UploadImageScreenCover({Key? key}) : super(key: key);

  @override
  _UploadImageScreenCoverState createState() => _UploadImageScreenCoverState();
}

class _UploadImageScreenCoverState extends State<UploadImageScreenCover> with Helpers{
  ...
  Future<void> upladImage() async{
    ...
    ImagesGetxControllerCover.to.uploadImage(filePath: xFile!.path,
